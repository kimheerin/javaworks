...
public class PlusCalcEvent {
	...
	public static void main(String[] args) {
		...
		JButton raseBtn = new JButton("취소");
		...
		ActionListener listener = new ActionListener() {				
			...
			public void actionPerformed(ActionEvent e) {
				int num1 = Integer.parseInt(text1.getText());	//입력한 문자를 숫자로 변환
				int num2 = Integer.parseInt(text2.getText());	//입력한 문자를 숫자로 변환
				int sum = num1 + num2;
				text3.setText(String.valueOf(sum));	//숫자를 문자열로 변환				
			}
		};
